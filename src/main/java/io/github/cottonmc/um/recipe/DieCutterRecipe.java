...
public class DieCutterRecipe implements Recipe<Inventory> {
	...
	public DieCutterRecipe(Identifier id, Ingredient ingredient, ItemStack result, int energy, int duration) {
		this.identifier = id;
